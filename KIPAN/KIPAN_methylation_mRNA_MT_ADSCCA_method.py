...
##############################
##############################
kidtx = pd.read_csv('KIPAN__methylation_mRNA_raw_data.csv')
...
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    ...
    np.savetxt("KIPAN_methylation_mRNA_MT-ADSCCA_20210902.csv",hist.history['loss'], delimiter=",")
...
#np.savetxt("KIPAN_data_mm_dscca_p001_8-9_20210910.csv",data_mm2, delimiter=",")

#pd.dataFrame.to_save()
data_y_mm_name55.to_csv("KIPAN_data_mm_dscca.csv")
